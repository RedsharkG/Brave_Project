...
<div class="container-fluid">
  <div class="container">
    ...
    <div class="row">
      <div class="col-xl-6"><img src="images/NfLy4u.jpg" alt="" width="1300" height="820" class="img-fluid"/></div>
      <div class="col-xl-6">
        <p class="text-center">&nbsp;</p>
        <p class="text-center">&nbsp;</p>
        <p class="text-center"><strong>SELECT THE&nbsp;</strong></p>
<p class="text-center"><strong>PERFECT SIZE&nbsp;</strong></p>
        <p class="text-center"><strong>THAT FITS&nbsp;</strong></p>
<p class="text-center"><strong>YOU </strong> </p>
&nbsp;</div>
    </div>
    <p>&nbsp;</p>
    <table width="800" border="2" align="center" cellpadding="5" cellspacing="5">
      <tbody>
        <tr>
          ...
          <td style="text-align: center">&nbsp;<strong>Sholder Width</strong></td>
          <td style="text-align: center"><strong>Product Length</strong>&nbsp;</td>
        </tr>
        <tr>
    ...
    <footer><!--    Above lines of codes for the first column in the footer -->
    <div class = "first-Col">
...
<hr class = "left-line" />
<p class = "copyright"> Copyrights &copy; Group 40</p></footer>
  </div>
</div>
